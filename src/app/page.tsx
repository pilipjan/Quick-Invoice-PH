        ...
        <div className="max-w-4xl w-full flex flex-col md:flex-row items-center md:items-start justify-between gap-8 mb-8">
          ...
          <div className="flex flex-col gap-4 items-center md:items-end">
            ...
            <a
              ...
              className="inline-flex items-center gap-2 px-4 py-2 rounded-full border border-surface-700 bg-surface-900 hover:border-primary-500/50 hover:bg-surface-800 transition-all text-sm font-semibold text-surface-300 hover:text-white group"
            >
              <svg viewBox="0 0 24 24" className="w-4 h-4 fill-current text-surface-400 group-hover:text-yellow-400 transition-colors" xmlns="http://www.w3.org/2000/svg">
            ...
            <div className="flex flex-wrap justify-center gap-6 text-xs text-surface-500 font-medium">
